...
snq(nqv,nbase),ardsq2(nqv,nbase),ardsq(nqv,nbase),databootrdsq(nqv,nbase) )
...
!------------------------------------!
 ...
 integer :: i,msteps,bins,shift,size,rank,ierr,j,nbins,qv,k
 integer(4) stats(MPI_STATUS_SIZE)
...
do i=1,nqv
 write(20,255)q(i,1),q(i,2),(fourq(1,1,i)+fourq(2,2,i)+fourq(3,3,i)+fourq(4,4,i)+fourq(5,5,i)+fourq(6,6,i))*(2.0/tp)**2,&
                            (fourq0(1,1,i)+fourq0(2,2,i)+fourq0(3,3,i)+fourq0(4,4,i)+fourq0(5,5,i)+fourq0(6,6,i))*(2.0/tp)**2
end do
close(20)
